	...
	*/
	...
	if ($capt != $_SESSION['CAPTCHAString']){
		...
		if exists (select userid from u6048user_id where loginid = '".$uname."')
			...
			begin
				insert into u6048user_id (userid, loginid, $cfgDbPasswordfield,userprefix,referral_agent,usertype,username,playerpt,telp,email,bankname,bankaccname,bankaccno,deposit_type,save_deposit,joindate,status,bankgrup,subwebid,flag) values ('".$unameid."', '".$uname."','".hash("sha256",md5($pass).'8080')."','".$cref."','".$ref_userid."','U','".$fname."','0','".$phone."','".$email."','".$bname."','".$baname."','".$bano5."','1','0',GETDATE(),'0','1','".$subwebid."','3')
			end"
		),SQLSRV_FETCH_ASSOC);
		if ($t["hasil"]=="1"){
                            ...
                            <div class="body-wrap">
                                ...
                                <form class="form-horizontal" role="form" method="POST">
                                    ...
                                    <div class="form-group-full">
                                        ...
                                        <div class="col-lg-2">
											<div id="ceklis5" class="validx"></div>
                                            <input onBlur="fast_checking('the_fname', 'ceklis5', '')" type="text" name="FName" id="the_fname" placeholder="Nama Lengkap Anda" value="<?php echo $fname; ?>" data-required="true" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group-full">
                                        ...
                                        <div class="col-lg-2">
                                            ...
                                            <input onBlur="fast_checking('the_email', 'ceklis6', '')" type="text" name="Email" id="the_email" placeholder="Email harus valid dan benar, email_anda@example.com" maxlength=40 value="<?php echo $email; ?>" class="form-control" data-required="true" data-type="email">
                                    ...
                                    <div class="form-group-full">
                                        ...
                                        <div class="col-lg-2">
                                            ...
                                            <input type="text" name="BAName" id="the_baname" onBlur="fast_checking('the_baname', 'ceklis8', '')" value="<?php echo $baname; ?>" placeholder="Nama Lengkap Anda Sesuai Buku tabungan" data-required="true" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group-full">
                                        ...
                                        <div class="col-lg-2">
                                            ...
                                            <input type="text" name="BAno" id="the_bano" onBlur="fast_checking('the_bano', 'ceklis9', 'the_bname')" value="<?php echo $bano; ?>" placeholder="Nomor Rekening Bank Anda" data-required="true" class="form-control">
                                        </div>
                                    </div>
									<?php
