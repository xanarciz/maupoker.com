...
<body >
	<center>
	<iframe src="<?php echo $path;?>/secure/change_nickname_whitelabel.php?public=<?php echo $publicKey;?>&data=<?php echo $encodedData;?>&login=<?php echo $user_login;?>&sb=<?php echo $subwebid;?>&key=<?php echo $password;?>" width="750" height="520"></iframe>
	<div style="width:100%;margin-top:30px;"><a href="index.php" class="btn btn-login" style="font-size:20px;">NEXT</a></div>
	</div>
</body>
<?php
exit();
