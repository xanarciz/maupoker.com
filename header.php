        ...
        <div id="header">
            ...
            <div class="container">
                ...
                ?>
                    ...
                    <?php if ($register==1 && $agentwlable != 'AXWYAA'){ ?><div class="forget-password" style="margin-top: 85px;margin-right: -351px;"><a href="forget-password.php">Forget password?</a></div> <?php } ?>
                <?php
                }else{
