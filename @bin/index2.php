                ...
                <div class="container">
                    ...
                    <div class="panel">
                        <div id="winner">
                            <div class="box">
								<?php
								$query = sqlsrv_query($sqlconn, "SELECT top 1 * from t6413txh_globaljackpothis order by TDate desc");
								...
								?>
                                <div class="title">Pemenang Jackpot Terakhir</div>
                                <hr />
                        ...
                        <div id="latest">
                            <div id="depo">
                                <div class="box">
                                    <div class="title">5 Deposit Terakhir</div>
                                    <div class="control">
                                    ...
                                    <div id="depo-pager">
                                        ...
                                        <div class="depo-item">
                                            <div class="avatar-small-default">
    								            <div class="avatar-small" style="background: url(<?php echo $img_deposit;?>) no-repeat;background-size:100%;"></div>
    							            </div>
                                            <div class="depo-info">
                                                <span class="depo-name"><?php echo $depuser[0];?></span>
                                                <div class="clear space_10"></div>
                                        ...
                                        <div class="depo-item">
                                            ...
                                            <div class="depo-info">
                                                <span class="depo-name"><?php echo $depuser[1];?></span>
                                                <div class="clear space_10"></div>
                                        ...
                                        <div class="depo-item">
                                            ...
                                            <div class="depo-info">
                                                <span class="depo-name"><?php echo $depuser[2];?></span>
                                                <div class="clear space_10"></div>
                                        ...
                                        <div class="depo-item">
                                            ...
                                            <div class="depo-info">
                                                <span class="depo-name"><?php echo $depuser[3];?></span>
                                                <div class="clear space_10"></div>
                                        ...
                                        <div class="depo-item">
                                            ...
                                            <div class="depo-info">
                                                <span class="depo-name"><?php echo $depuser[4];?></span>
                                                <div class="clear space_10"></div>
                            ...
                            <div id="wd">
                                <div class="box">
                                    <div class="title">5 Withdraw Terakhir</div>
                                    ...
                                    <div class="wd-item">
                                        <div class="avatar-small-default">
								            <div class="avatar-small" style="background: url(<?php echo $img_withdraw;?>) no-repeat;background-size:100%;"></div>
							            </div>
                                        <div class="wd-info">
                                            <span class="wd-name"><?php echo $withuser[0];?></span>
                                            <div class="clear space_10"></div>
                                    ...
                                    <div class="wd-item">
                                        ...
                                        <div class="wd-info">
                                            <span class="wd-name"><?php echo $withuser[1];?></span>
                                            <div class="clear space_10"></div>
                                    ...
                                    <div class="wd-item">
                                        ...
                                        <div class="wd-info">
                                            <span class="wd-name"><?php echo $withuser[2];?></span>
                                            <div class="clear space_10"></div>
                                    ...
                                    <div class="wd-item">
                                        ...
                                        <div class="wd-info">
                                            <span class="wd-name"><?php echo $withuser[3];?></span>
                                            <div class="clear space_10"></div>
                                    ...
                                    <div class="wd-item">
                                        ...
                                        <div class="wd-info">
                                            <span class="wd-name"><?php echo $withuser[4];?></span>
                                            <div class="clear space_10"></div>
