                            ...
                            <div class="body-wrap">
                                <form class="form-horizontal" role="form" method="POST">
									...
									<div class="form-group-full">
                                        ...
                                        <div class="col-lg-2">
                                            <input type="text" name="UNameid" id="user_nameid" placeholder="Tampilan anda dalam game" maxlength=10 value="<?php echo $unameid; ?>" data-required="true" class="form-control">
											 <div class="clear space_5"></div>
											<div>
                                    ...
                                    <div class="form-group-full">
                                        ...
                                        <div class="col-lg-2">
                                            <input type="text" name="Email" placeholder="email_anda@example.com" maxlength=40 value="<?php echo $email; ?>" class="form-control" data-required="true" data-type="email">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group-full">
                                        ...
                                        <div class="col-lg-2">
                                            <input type="text" name="Phone" placeholder="Nomor Telepon Anda"  maxlength=13 value="<?php echo $phone; ?>" data-required="true" class="form-control">
                                        </div>
                                    </div>
