...
<div class="content-2">
	...
	<div class="row">		
		...
		<?php
			if ($errorReport){
				echo "<div class='padding-15' align='center' id='the_alert' style='color: #000;'>".$errorReport."</div>";
			}else{
				echo "<div class='padding-15' align='center' id='the_alert' style='display: none; color: #000;'></div>";
			}
		?>
	</div>
	...
	<form method="post" id="form_reg">
		...
		<div class="row padding-15 tpadding-3 bpadding-2">
			<div class="col-lg-5 tmargin-5">
				<label class="black">Nama</label>
			</div>
			<div class="col-lg-7">
				<input class="form-control bg-light-gray" onBlur="fast_checking('the_fname', 'ceklis5', '')" id="the_fname" type="text" name="FName" value="<?php echo $_POST["FName"]; ?>" />
			</div>
		</div>
		...
		<div class="row padding-15 tpadding-3 bpadding-2">
			...
			<div class="col-lg-7">				
				<input class="form-control bg-light-gray place-red" onBlur="fast_checking('the_baname', 'ceklis8', '')" id="the_baname" type="text" maxlength="25" name="BAName" value="<?php echo $_POST["BAName"]; ?>" placeholder="*Nama sesuai buku tabungan Anda" />
			</div>
		</div>
