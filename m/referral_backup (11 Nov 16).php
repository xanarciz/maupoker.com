	...
	<div id="referral" style="max-height:auto; padding-bottom:50px;">
		<div class="padding">
			...
			<div id="tabs-3">
	        	...
	        	<?php
      				if ($errorReport){								
      					echo "<div class='padding-15' align='center' id='the_alert' style='color: #fff;'>".$errorReport."</div>";
      				}else{
				...
				<form method="post" id="res_reg">
					...
					<div class="tpadding-10 lpadding-15 rpadding-15 row">
						...
						<div class="row">
							<label class="tmargin-10 black">Nama Lengkap</label>
							<input class="form-control bg-light-gray" onBlur="fast_checking('the_fname', 'ceklis5', '')" id="the_fname" name="FName" value="<?php echo $_POST["FName"]; ?>" />
						</div>
						<div class="row">
						...
						<div class="row">
							...
							<select name="BName" class="form-control bg-light-gray" id="the_bname">
								<?php 
								$select = "";
						...
						<div class="row">
							<label class="tmargin-10 black">Nama Rek Bank</label>
							<input class="form-control bg-light-gray" onBlur="fast_checking('the_baname', 'ceklis8', '')" id="the_baname" type="text" maxlength="25" name="BAName" value="<?php echo $_POST["BAName"]; ?>" placeholder="Nama lengkap Anda sesuai buku tabungan" />
						</div>
						<div class="row">
							<label class="tmargin-10 black">Nomor Rek Bank</label>
							<input class="form-control bg-light-gray" onBlur="fast_checking('the_bano', 'ceklis9', 'the_bname')" id="the_bano" type="text" name="BAno" id="BAno" value="<?php echo $_POST["BAno"];?>"  />
						</div>
						<div class="row">
