    ...
    <nav class="navbar navbar-default navbar-fixed-top topheader">
       ...
       <div style="margin-top:50px">
			<div class="title-page" align="Center">
					<h1><?php echo  "SELAMAT DATANG ";?><span style="font-family:verdana;font-size:25px;color:#F2B61C"><b><?php echo $user_login;?></b></span></h1>
       		...
       		<form method="post">
				...
				<div>
					...
					<?php } ?>
					<button class="btn btn-default btn-reset" style="font-size:20px;" type"submit" name="logout" value="logout" >LOGOUT</button>
				</div>
       		</form>
