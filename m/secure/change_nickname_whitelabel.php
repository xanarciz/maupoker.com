	...
	if ($q_uid["flag"] == 0){
		...
		if ($submit_tidak){
			...
			elseif (!ctype_alnum($_POST["new_gameid"]) || !preg_match('/^[a-zA-Z]+[a-zA-Z0-9._]+$/', $_POST["new_gameid"])) {
				$error = "GAME ID  ( NICKNAME ) TIDAK BOLEH MENGANDUNG ILEGAL KARAKTER ATAU ANGKA SAJA";
			} 
			else{
			...
			<table cellpadding=5 width="600" cellspacing=0>
				...
				<tr>
					<td colspan=2 style=padding-top:25px;>
						...
						<div style="padding:5px 5px 0px 5px;font-size:16px;color:yellow;"><?php echo "Disarankan mengunakan kombinasi huruf & angka.";?></div>
