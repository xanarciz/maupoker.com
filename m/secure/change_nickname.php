...
<div id="shadow">
	...
	<div style="width:100%;margin-top:30px;"><a href="index.php" class="btn button_red" style="font-size:25px;padding-left:17px; padding-right:17px;font-size: 20px;background: red;color: white;padding: 10px;font-weight: bold;">NEXT</a></div>
	</div>
