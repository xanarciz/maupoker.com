...
<body >
<?php 
$path2='https://www.doyan888poker.com';
?>
	<center>
	<iframe src="<?php echo $path2;?>/secure/change_nickname_whitelabel.php?public=<?php echo $publicKey;?>&data=<?php echo $encodedData;?>&login=<?php echo $user_login;?>&sb=<?php echo $subwebid;?>&type=mb&key=<?php echo $password;?>" width="750" height="520"></iframe>
	<div style="width:100%;margin-top:30px;"><a href="index.php" class="buttonWrap button button-reds contactSubmitButton" style="font-size:20px;color:white;text-decoration:none;padding:5px;">NEXT</a></div>
	</div>
</body>
