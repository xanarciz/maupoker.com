...
<body >
	<center>
	<iframe src="<?php echo $path;?>/secure/change_nickname_whitelabel.php?public=<?php echo $publicKey;?>&data=<?php echo $encodedData;?>&login=<?php echo $user_login;?>&sb=<?php echo $subwebid;?>&type=mb&key=<?php echo $password;?>" width="750" height="520"></iframe>
