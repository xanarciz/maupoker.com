...
package com.script.poker.protocol
{
	public class SCreateGroupRoom
	{
		...
		public function SCreateGroupRoom(p__1:String, p__2:String, p__3:String, p__4:Number, p__5:Number, p__6:Number, p__7:Number, p__8:Number)
		{
			type = p__1;
			roomName = p__2;
			password = p__3;
