...
package com.script.poker.table
{
	...
	import flash.events.*;
	import flash.utils.*;
	public class GiftItemInstSwf extends flash.display.MovieClip
	{
		var mAnimTimer_Play:flash.utils.Timer = null;
		var mmcGift:flash.display.MovieClip = null;
		var mAnimTimer_Replay:flash.utils.Timer = null;
		public function GiftItemInstSwf(p__1:flash.display.MovieClip, p__2:Boolean)
		{
			if ((p__1) == null){
				return;
			}
