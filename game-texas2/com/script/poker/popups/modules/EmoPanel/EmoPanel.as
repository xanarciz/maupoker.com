...
package com.script.poker.popups.modules.EmoPanel
{
	...
	import flash.net.*;
	public class EmoPanel extends flash.display.MovieClip
	{
		public var sZid:String;
		public var cancelBtn:*;
		private var tabSet:Array;
		private var aEmoItems:Array;
		public var feedCheck:flash.display.MovieClip;
		public var prevBtn:flash.display.MovieClip;
		public var nextBtn:flash.display.MovieClip;
		...
		public var buyBtn:*;
		private var firstID:Number = 1;
		private var _selected:* = null;
		private var _selectStr:* = null;
		public var langs;
		public function EmoPanel()
		{
		}
		public function preflight(p__1:*)
		{
			...
			//wtBtn = new com.script.poker.table.asset.PokerButton(l__2, "large", "Buy For Table\n(0)", null, 125, 5, 36, -2);
			buyBtn = new com.script.poker.table.asset.PokerButton(l__2, "large", langs.l_used, null, 125, 5);
		...
		private function initListeners():void
		{
			...
			//nextBtn.addEventListener(flash.events.MouseEvent.CLICK, onNextBuy);
			//prevBtn.addEventListener(flash.events.MouseEvent.CLICK, onPrevBuy);
		...
		private function removeListeners():void
		{
			...
			//nextBtn.removeEventListener(flash.events.MouseEvent.CLICK, onNextBuy);
			//prevBtn.removeEventListener(flash.events.MouseEvent.CLICK, onPrevBuy);
		}
		private function onBuy(p__1:flash.events.MouseEvent):void
		{
			
			if (sPanelMode == com.script.poker.popups.modules.events.EmoEvent.PANELMODE_BUY){
				startBuyTimer();
				dispatchEvent(new com.script.poker.popups.modules.events.EmoBuyEvent(com.script.poker.popups.modules.events.EmoEvent.BUYEMO, sZid, GetCurrentTabCategoryId(), _selected, false, false, _selectStr));
			} else if (sPanelMode == com.script.poker.popups.modules.events.EmoEvent.PANELMODE_SELECT){
				dispatchEvent(new com.script.poker.popups.modules.events.EmoBuyEvent(com.script.poker.popups.modules.events.EmoEvent.DISPLAY_NONE, "", GetCurrentTabCategoryId(), -1, false, false, GetCurrentTabCategoryStr()));
			} else if (sPanelMode == com.script.poker.popups.modules.events.EmoEvent.PANELMODE_DISPLAY){
			}
		}
		private function onBuyForTable(p__1:flash.events.MouseEvent):void
		{
			if (sPanelMode == com.script.poker.popups.modules.events.EmoEvent.PANELMODE_BUY){
				startBuyTimer();
				dispatchEvent(new com.script.poker.popups.modules.events.EmoBuyEvent(com.script.poker.popups.modules.events.EmoEvent.BUYFORTABLE, sZid, GetCurrentTabCategoryId(), _selected, true, false));
			} else if (sPanelMode == com.script.poker.popups.modules.events.EmoEvent.PANELMODE_SELECT){
				dispatchEvent(new com.script.poker.popups.modules.events.EmoBuyEvent(com.script.poker.popups.modules.events.EmoEvent.DISPLAY_SELECTED, "", GetCurrentTabCategoryId(), _selected, true, false));
			} else if (sPanelMode == com.script.poker.popups.modules.events.EmoEvent.PANELMODE_DISPLAY){
			}
		}
		public function onCancel(p__1:flash.events.MouseEvent):void
		{
			stopBuyTimer(false);
			clear_all_tabs();
			dispatchEvent(new com.script.poker.popups.modules.events.EmoEvent(com.script.poker.popups.modules.events.EmoEvent.CANCEL, sZid));
		}
		private function onFeedCheck(p__1:flash.events.MouseEvent):void
		{
			dispatchEvent(new com.script.poker.popups.modules.events.EmoEvent(com.script.poker.popups.modules.events.EmoEvent.FEED_CHECK, ""));
			swapFeedCheck();
		}
		private function onNextBuy(p__1:flash.events.MouseEvent):void
		{
			//dispatchEvent(new com.script.poker.popups.modules.events.EmoEvent(com.script.poker.popups.modules.events.EmoEvent.FEED_CHECK, ""));
			//swapFeedCheck();
		}
		private function onPrevBuy(p__1:flash.events.MouseEvent):void
		{
			//dispatchEvent(new com.script.poker.popups.modules.events.EmoEvent(com.script.poker.popups.modules.events.EmoEvent.FEED_CHECK, ""));
			//swapFeedCheck();
		}
		...
		{
			if (nCurrentTab >= 0){
				return(tabSet[nCurrentTab].tabTop.EmoCatID);
			}
			return(-1);
		}
		public function GetCurrentTabCategoryStr():String
		{
			if (nCurrentTab >= 0){
				var l__13 = com.script.poker.table.EmoLibrary.GetInst().GetEmo(tabSet[nCurrentTab].tabTop.EmoCatID);
				return(l__13.msName);
			}
			return(" ");
		}
		public function populate_current_tab()
		{
			...
			populate_tab_withEmoCategory(tabSet[l__1].tabTop.ID, tabSet[l__1].tabTop.EmoCatID, tabSet[l__1].tabTop.inSenderName, tabSet[l__1].tabTop.panelmode);
		}
		...
		public function clear_tab(p__1:Number)
		{
			...
			if (mImageList && !(mImageList[l__2] == null)){
				while(mImageList[l__2].length > 0){
					...
					com.script.poker.table.EmoLibrary.GetInst().ReleaseEmoMovieClip(l__3);
				}
			}
		...
		public function populate_tab_withEmoCategory(p__1:Number, p__2:String, p__3:Array = null, p__4:String = "buy")
		{
			var l__13:com.script.poker.table.EmoItem;
			var l__14:EsingleItem;
			var l__15:Number = 0;
			var l__5:* = p__1;
			var l__6:Number = 0;
			var l__7:com.script.poker.table.EmoCategory = com.script.poker.table.EmoLibrary.GetInst().GetEmoCategory(p__2);
			
			if (l__7 == null){
				return;
			}
			firstID = l__7.maEmoInCat[0];
			var l__8:* = l__7.maEmoInCat ? l__7.maEmoInCat.length : 0;
			var l__9:* = 0;
			clear_tab(p__1);
			...
			var l__11:* = true;
			if (l__8 == 0){
				tabSet[l__5].altcontent.text = "These Emos are not available to underage users on Facebook. Sorry!";
			} else {
				tabSet[l__5].altcontent.text = "";
			}
			var l__12 = 0;
			while(l__12 < l__8){
				l__13 = com.script.poker.table.EmoLibrary.GetInst().GetEmo(l__7.maEmoInCat[l__12]);
				l__14 = new EsingleItem();
				l__15 = 0;
				l__10 = null;
				l__15 = l__6;
				l__14.ID = (sPanelMode == com.script.poker.popups.modules.events.EmoEvent.PANELMODE_BUY) ? l__13.mnId : l__6;
				...
				if (l__13.mbGreyOut){
					...
					l__14.info.htmlText = ((("<b>" + l__13.msName) + "</b>"));
					//l__14.info.htmlText = ((("<b>" + l__13.msName) + "</b><br>") + l__13.mnPrice);
				}
				if (bIsOwner){
					if (l__11){
						l__10 = com.script.poker.table.EmoLibrary.GetInst().CreateEmoMovieClip(1, l__13.mnId);
						if (l__10){
						...
						tabSet[l__5].altcontent.text = "These Emos are no longer available to underage users on Facebook. Sorry!";
					}
				} else if (l__11){
					l__10 = com.script.poker.table.EmoLibrary.GetInst().CreateEmoMovieClip(1, l__13.mnId);
					if (l__10){
					...
					tabSet[l__5].altcontent.text = "This user has elected not to receive these Emos.";
				}
				l__6++;
				l__12++;
			}
		}
		public function populate_tab_withSpecificEmo(p__1:Number, p__2:Array, p__3:Array = null, p__4:String = "buy")
		{
			var l__12:com.script.poker.table.EmoItem;
			var l__13:* = undefined;
			var l__14:Number = 0;
			var l__15:String;
			var l__5:* = p__1;
			...
			var l__11 = 0;
			while(l__11 < l__7){
				l__12 = com.script.poker.table.EmoLibrary.GetInst().GetEmo(p__2[l__11]);
				l__10 = isEmoIdAllowed(l__12.mnId);
				if (!l__10){
				} else {
					l__13 = new EsingleItem();
					l__14 = 0;
					l__9 = null;
					l__14 = l__6;
					l__13.ID = (sPanelMode == com.script.poker.popups.modules.events.EmoEvent.PANELMODE_BUY) ? l__12.mnId : l__6;
					l__13.x = (50 + (xJump * (l__14 % 5)));
					l__13.y = (65 + (yJump * Math.floor(l__14 / 5)));
					mItemList[l__5].push(l__13);
					if ((sPanelMode == com.script.poker.popups.modules.events.EmoEvent.PANELMODE_SELECT) || (sPanelMode == com.script.poker.popups.modules.events.EmoEvent.PANELMODE_DISPLAY)){
						l__15 = p__3[l__6];
						if (sPanelMode == com.script.poker.popups.modules.events.EmoEvent.PANELMODE_SELECT){
						...
						l__9 = com.script.poker.table.EmoLibrary.GetInst().CreateEmoMovieClip(l__8, l__12.mnId);
						if (l__9){
		...
		public function populate_buy(p__1:Array, p__2:Number, p__3:Array, p__4:Array = null, p__5:String = "buy")
		{
			var l__6:* = undefined;
			var l__7:Number = 0;
			var l__8:com.script.poker.table.EmoCategory;
			nCurrentTab = 0;
			sPanelMode = p__5;
			initListeners();
			setupButtons();
			...
			while(l__7 < (p__1.length)){
				tabSet[l__7] = new ETabItem();
				l__8 = com.script.poker.table.EmoLibrary.GetInst().GetEmoCategory(p__1[l__7]);
				...
				tabSet[l__7].tabTop.EmoCatID = p__1[l__7];
				...
				bShowNone = l__8.maEmoInCat.length > 0;
				if ((sPanelMode == com.script.poker.popups.modules.events.EmoEvent.PANELMODE_DISPLAY) || (sPanelMode == com.script.poker.popups.modules.events.EmoEvent.PANELMODE_SELECT)){
					if (l__8.maEmoInCat.length == 0){
						tabSet[l__7].altcontent.text = "Today\'s Emo is empty!";
					}
				}
				populate_tab_withEmoCategory(l__7, p__1[l__7]);
				l__7++;
			}
			if (tabSet.length > 0){
		...
		public function populate_select_or_display(p__1:Array, p__2:Number, p__3:Array, p__4:Array = null, p__5:String = "buy")
		{
			...
			populate_tab_withSpecificEmo(l__7, p__1, p__4, p__5);
			if ((sPanelMode == com.script.poker.popups.modules.events.EmoEvent.PANELMODE_DISPLAY) || (sPanelMode == com.script.poker.popups.modules.events.EmoEvent.PANELMODE_SELECT)){
				if ((p__1.length) == 0){
					tabSet[l__7].altcontent.text = "Today\'s Emo is empty!";
				}
		...
		{
			if ((p__5) == com.script.poker.popups.modules.events.EmoEvent.PANELMODE_BUY){
		...
		{
			dispatchEvent(new com.script.poker.popups.modules.events.EmoEvent(com.script.poker.popups.modules.events.EmoEvent.DSG_UPDATE, sZid));
			nCurrentTab = p__1.target.ID;
			dispatchEvent(new com.script.poker.popups.modules.events.EmoEvent(com.script.poker.popups.modules.events.EmoEvent.REFRESH_CATEGORY, sZid, p__1.target.EmoCatID));
		...
		{
			var l__2:com.script.poker.table.EmoItem;
			var l__3:Number = 0;
			var l__4:Boolean;
			disableButtons();
			_selected = p__1;
			...
			if ((p__1) != null){
				if (sPanelMode == com.script.poker.popups.modules.events.EmoEvent.PANELMODE_BUY){
					l__2 = com.script.poker.table.EmoLibrary.GetInst().GetEmo(p__1);
					nTotalPlayers = getAllowedPlayers(p__1);
					l__3 = l__2.mnPrice * nTotalPlayers;
					_selectStr = l__2.msName;
					l__4 = true;
		...
		private function setupButtons():void
		{
			...
			buyBtn.visible = (sPanelMode == com.script.poker.popups.modules.events.EmoEvent.PANELMODE_DISPLAY) ? false : true;
			if (sPanelMode == com.script.poker.popups.modules.events.EmoEvent.PANELMODE_BUY){
				//wtBtn.changeText("Buy For Table\n(0)");
				buyBtn.changeText(langs.l_used);
			} else if (sPanelMode == com.script.poker.popups.modules.events.EmoEvent.PANELMODE_SELECT){
		...
		public function isEmoIdAllowed(p__1:Number):Boolean
		{
			var l__3:* = undefined;
			var l__2:com.script.poker.table.EmoItem = com.script.poker.table.EmoLibrary.GetInst().GetEmo(p__1);
			if (l__2 == null){
				return(true);
			}
		...
		public function getEmoById(p__1:int):Object
		{
			return(com.script.poker.table.EmoLibrary.GetInst().GetEmo((p__1).AS3::toString()) as Object);
		}
		...
		private function startBuyTimer():void
		{
			if (sPanelMode == com.script.poker.popups.modules.events.EmoEvent.PANELMODE_BUY){
				if (buyTimer == null){
					buyTimer = new flash.utils.Timer(5000);
					buyTimer.addEventListener(flash.events.TimerEvent.TIMER, onBuyEmo);
					buyTimer.start();
				}
				//wtBtn.setActivity(false);
				buyBtn.setActivity(false);
		...
		private function stopBuyTimer(p__1:Boolean):void
		{
			if (sPanelMode == com.script.poker.popups.modules.events.EmoEvent.PANELMODE_BUY){
				if (buyTimer != null){
					buyTimer.stop();
					buyTimer.removeEventListener(flash.events.TimerEvent.TIMER, onBuyEmo);
					buyTimer = null;
				}
		...
		private function onBuyEmo(p__1:flash.events.TimerEvent):void
		{
