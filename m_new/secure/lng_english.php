...
$strPwFalse           = "Incorrect Username/Password";
$strPwNotFound        = "No password was found in the database";
$strUserNotAllowed    = "This user is not allowed access to this page";
$strUserNotExist      = "Incorrect Username/Password";
$strValFalse          = "Wrong Validation Code";
$strNoVal             = "Validation Code Empty";

// Interface words
$strCancel            = "Cancel";
$strEnter             = "Enter";
$strInfoOn            = "information on";
$strJSHello           = "Please complete below fields";
$strLogin             = "Login";
$strLoginInterface    = "Login Page";
